...
namespace DestroyIt
{
    ...
    public class DestructibleEditor : Editor
    {
        ...
        private SerializedProperty rotationOverride;
        ...
        public void OnEnable()
        {
            ...
            rotationOverride = serializedObject.FindProperty("rotationOverride");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Separator();
                ...
                if (destructible.useFallbackParticle)
                {
                    ...
                    destructible.rotationOverride = EditorGUILayout.Vector3Field(new GUIContent("Rotation Override", "Here you can override the rotation of the particle effect"), rotationOverride.vector3Value);
                    EditorGUILayout.EndVertical();
                    EditorGUILayout.EndHorizontal();
                }
                EditorGUILayout.Separator();
